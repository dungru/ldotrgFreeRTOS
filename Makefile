...
OBJS += \
      $(PWD)/FreeRTOS/Source/croutine.o \
      $(PWD)/FreeRTOS/Source/event_groups.o \
      $(PWD)/FreeRTOS/Source/list.o \
      $(PWD)/FreeRTOS/Source/queue.o \
      $(PWD)/FreeRTOS/Source/tasks.o \
      $(PWD)/FreeRTOS/Source/timers.o \
      $(PWD)/FreeRTOS/Source/portable/GCC/ARM_CM4F/port.o \
      $(PWD)/FreeRTOS/Source/portable/MemMang/heap_1.o \
...
OBJS += \
    ...
    $(PWD)/CORTEX_M4F_STM32F407ZG-SK/Utilities/STM32F429I-Discovery/stm32f429i_discovery.o \
    $(PWD)/CORTEX_M4F_STM32F407ZG-SK/Utilities/STM32F429I-Discovery/stm32f429i_discovery_sdram.o \
    $(PWD)/CORTEX_M4F_STM32F407ZG-SK/Utilities/STM32F429I-Discovery/stm32f429i_discovery_lcd.o \
    $(PWD)/CORTEX_M4F_STM32F407ZG-SK/Utilities/STM32F429I-Discovery/stm32f429i_discovery_ioe.o
...
CFLAGS += -I $(PWD)/CORTEX_M4F_STM32F407ZG-SK \
	  -I $(PWD)/FreeRTOS/Source/portable/GCC/ARM_CM4F \
	  -I $(PWD)/FreeRTOS/Source/include \
	  ...
	  -I $(PWD)/CORTEX_M4F_STM32F407ZG-SK/Utilities/STM32F429I-Discovery
